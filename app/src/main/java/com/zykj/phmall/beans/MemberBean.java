...
public class MemberBean {
    ...
    public String invite_three;//
    public String member_tj;//
    public String member_ceng;//
    public String member_red_points;//
    public String kucun_points;//
    public String member_licence_number;//
    public String shuifei;//
    public String level;//
    public String level_name;//会员等级
