...
import com.zykj.phmall.presenter.MyPlanPresenter;
 ...
 */
public class MyPlanActivity extends ToolBarActivity<MyPlanPresenter> {
    ...
    protected void initAllMembersView() {
        ...
        // 加载需要显示的网页
        wv_recharge.loadUrl("http://puhui.ofabao.com/wap/tmpl/member/member_invite.html");
        // 设置Web视图
