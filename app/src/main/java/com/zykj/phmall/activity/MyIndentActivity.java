...
import com.zykj.phmall.presenter.MyIndentPresenter;
 ...
 */
public class MyIndentActivity extends ToolBarActivity<MyIndentPresenter> {
    ...
    @Override
    public MyIndentPresenter createPresenter() {
        return new MyIndentPresenter();
    }
    ...
    protected void initAllMembersView() {
        ...
        // 加载需要显示的网页
        wv_recharge.loadUrl("http://puhui.ofabao.com/wap/tmpl/member/order_list.html");
        // 设置Web视图
